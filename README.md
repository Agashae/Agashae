...
🚀 J’aime construire, casser, comprendre et reconstruire des systèmes  
🧠 Curieux de tout : informatique, réseaux, systèmes, spatial et technologie en général  
...
J’aime surtout comprendre ce qu’il y a derrière les choses.

Parfois je teste, parfois je casse, mais surtout j’apprends 😄
...
Un projet construit pour comprendre le web de A à Z :

- Structure HTML
- Design CSS
- Navigation et logique frontend
- Déploiement web

👉 Objectif : maîtriser le fonctionnement réel d’un site web sans framework
